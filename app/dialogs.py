...
GET_RESULTS_NUM_MESSAGE = (
    '*Введите требуемое количество результатов* '
    f'(1 - {environ.get("MAX_RESULTS")}):')
...
GET_PHOTOS_NUM_MESSAGE = (
    '*Введите требуемое количество фотографий* '
    f'(1 - {environ.get("MAX_PHOTOS")}):')
WRONG_PHOTOS_NUM_MESSAGE = 'Количество должно быть числом.'
SELECT_PHOTOS_NUM_MESSAGE = 'Количество фотографий '
